 ...
 */
package com.github.epimethix.accounting.db.repository;
...
public class AccountManagerRepositoryImpl extends SQLRepository<AccountManagerImpl, Long> implements AccountManagerRepository {
	public AccountManagerRepositoryImpl(Database db) throws ConfigurationException {
		super(db, AccountManagerImpl.class, Long.class);
	}
}
