...
public class AccountRepositoryImpl extends SQLRepository<Account, Long> implements AccountRepository {
	public AccountRepositoryImpl(Database db) throws ConfigurationException {
		super(db, Account.class, Long.class);
	}
}
