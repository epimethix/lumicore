...
public class TransactionRepositoryImpl extends SQLRepository<Transaction, Long> implements TransactionRepository {
	public TransactionRepositoryImpl(Database db) throws ConfigurationException {
		super(db, Transaction.class, Long.class);
	}
}
