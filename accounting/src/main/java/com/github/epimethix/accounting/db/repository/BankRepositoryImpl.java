...
public class BankRepositoryImpl extends SQLRepository<Bank, Long> implements BankRepository {
	public BankRepositoryImpl(Database db) throws ConfigurationException {
		super(db, Bank.class, Long.class);
	}
}
