...
public abstract class AbstractIntegerEntity implements Entity<Long> {

	@PrimaryKey
	@Column(name = ID)
	private final Long id;

	public AbstractIntegerEntity(Long id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AbstractIntegerEntity other = (AbstractIntegerEntity) obj;
		if (id == null) {
			if (other.id != null)
				return false;
