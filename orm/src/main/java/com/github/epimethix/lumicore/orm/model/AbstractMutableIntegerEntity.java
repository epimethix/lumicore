...
public abstract class AbstractMutableIntegerEntity implements MutableEntity<Long> {
	@PrimaryKey
	@Column(name = ID)
	private Long id;

	protected AbstractMutableIntegerEntity() {}

	protected AbstractMutableIntegerEntity(Long id) {
		this.id = id;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AbstractMutableIntegerEntity other = (AbstractMutableIntegerEntity) obj;
		if (id == null) {
			if (other.id != null)
				return false;
